...
def ibm_api():
    ...
    authenticator = IAMAuthenticator('api_key') #change your api key
    ...
    text_final.seek(0)
    client.put_object(Bucket=bucket_name, Body=text_final.getvalue(), Key='') #locatio you want to save the file
